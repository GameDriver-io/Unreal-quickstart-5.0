...
#include "UnrealCLR/Public/AGDIO_OverlapHit.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeAGDIO_OverlapHit() {}
// Cross Module References
	UNREALCLR_API UClass* Z_Construct_UClass_AGDIO_OverlapHit_NoRegister();
	UNREALCLR_API UClass* Z_Construct_UClass_AGDIO_OverlapHit();
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AGDIO_OverlapHit_Statics::NewProp_hitResult = { "hitResult", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGDIO_OverlapHit, hitResult), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UClass_AGDIO_OverlapHit_Statics::NewProp_hitResult_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGDIO_OverlapHit_Statics::NewProp_hitResult_MetaData)) }; // 1416937132
	...
	template<> UNREALCLR_API UClass* StaticClass<AGDIO_OverlapHit>()
	{
		return AGDIO_OverlapHit::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AGDIO_OverlapHit);
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_UnrealCLR_Source_UnrealCLR_Public_AGDIO_OverlapHit_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_UnrealCLR_Source_UnrealCLR_Public_AGDIO_OverlapHit_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGDIO_OverlapHit, AGDIO_OverlapHit::StaticClass, TEXT("AGDIO_OverlapHit"), &Z_Registration_Info_UClass_AGDIO_OverlapHit, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGDIO_OverlapHit), 3592800007U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_UnrealCLR_Source_UnrealCLR_Public_AGDIO_OverlapHit_h_2531372084(TEXT("/Script/UnrealCLR"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_UnrealCLR_Source_UnrealCLR_Public_AGDIO_OverlapHit_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_UnrealCLR_Source_UnrealCLR_Public_AGDIO_OverlapHit_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
